...
ListViewItem :: struct {
	...
	backColor : uint,			// back color of the item
	foreColor : uint,			// fore color of the item
...
ListViewSubItem :: struct {
	...
	backColor : uint,			// back color of the sub item
	foreColor : uint,			// fore color of the sub item
...
newListView :: proc(f : ^Form, x, y, w, h : int) -> ListView
newListView :: proc(f : ^Form) -> ListView
