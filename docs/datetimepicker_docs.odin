...
// Constructors
newDateTimePicker :: proc(parent : ^Form) -> DateTimePicker
newDateTimePicker :: proc(parent : ^Form, x, y : int) -> DateTimePicker
newDateTimePicker :: proc(parent : ^Form, x, y, w, h : int) -> DateTimePicker
...
dtp = newDateTimePicker(&frm, 20, 50, 180, 30) // Create a dtp struct with given location & size
