...
// Constructor
new_radiobutton :: proc(parent : ^Form) -> RadioButton
new_radiobutton :: proc(parent : ^Form, txt : string) -> RadioButton
new_radiobutton :: proc(parent : ^Form, txt : string, x, y : int) -> RadioButton
new_radiobutton :: proc(parent : ^Form, txt : string, x, y, w, h : int) -> RadioButton
