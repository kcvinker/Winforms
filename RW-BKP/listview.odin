...
ListViewColumn :: struct {
	...
	headerAlign : SimpleTextAlignment,
...
newListView :: proc{lv_ctor1, lv_ctor2}
...
lv_ctor :: proc(f : ^Form, x, y, w, h : int) -> ListView {
	...
	lv._beforeCreation = cast(CreateDelegate) lv_before_creation
	lv._afterCreation = cast(CreateDelegate) lv_after_creation
