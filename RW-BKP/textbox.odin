...
@private tb_ctor :: proc(p : ^Form, w : int = 200, h : int = 0) -> TextBox {
    ...
    tb._beforeCreation = cast(CreateDelegate) tb_before_creation
    tb._afterCreation = cast(CreateDelegate) tb_after_creation
...
newTextBox :: proc{new_tb1, new_tb2}
    ...
    switch msg {
        ...
        case WM_LBUTTONDOWN:
           // tb._drawFocusRect = true
            ...
            if tb.onLeftMouseDown != nil {
                mea := new_mouse_event_args(msg, wp, lp)
                tb.onLeftMouseDown(tb, &mea)
                //return 0
            }
            //return 0
        ...
        case WM_LBUTTONUP :
            if tb.onLeftMouseUp != nil {
                mea := new_mouse_event_args(msg, wp, lp)
                tb.onLeftMouseUp(tb, &mea)
            }
