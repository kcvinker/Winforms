...
@private cb_ctor :: proc(p : ^Form, txt : string = "") -> CheckBox {
    ...
    cb._beforeCreation = cast(CreateDelegate) cb_before_creation
	cb._afterCreation = cast(CreateDelegate) cb_after_creation
    return cb
}


// Constructor for Checkbox type.
newCheckBox :: proc{new_checkbox1, new_checkbox2}
...
@private cb_wnd_proc :: proc "std" (hw : HWND, msg : u32, wp : WPARAM, lp : LPARAM,
    ...
    switch msg {
        ...
        case WM_LBUTTONDOWN:
            ...
            if cb.onLeftMouseDown != nil {
                mea := new_mouse_event_args(msg, wp, lp)
                cb.onLeftMouseDown(cb, &mea)
                return 0
            }
        ...
        case WM_LBUTTONUP :
            if cb.onLeftMouseUp != nil {
                mea := new_mouse_event_args(msg, wp, lp)
                cb.onLeftMouseUp(cb, &mea)
            }
